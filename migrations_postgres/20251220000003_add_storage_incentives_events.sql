-- Add storage_incentives_events table for PriceOracle, StakeRegistry, and Redistribution events (PostgreSQL)
-- Created: 2025-12-20
...
CREATE TABLE IF NOT EXISTS storage_incentives_events (
    ...
    round_number BIGINT,            -- block_number / 152 (for redistribution/price oracle)
